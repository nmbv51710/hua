...
function checkOS() {
	if [[ -e /etc/debian_version ]]; then
		...
		echo "Looks like you aren't running this installer on Debian 10"
		exit 1
	fi
}

function installQuestions() {
	echo "A few questions before starting the setup, you can leave the default options and just press enter if you are ok with them."
